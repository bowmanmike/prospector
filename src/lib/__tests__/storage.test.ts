...
describe('VaultStorage', () => {
  ...
  describe('init', () => {
    ...
    it('should create object store on upgrade', async () => {
      ...
      expect(mockDB.createObjectStore).toHaveBeenCalledWith('vault-settings', { keyPath: 'id' })
  ...
  describe('saveVaultFiles', () => {
    it('should save vault files successfully', async () => {
      ...
      expect(mockDB.transaction).toHaveBeenCalledWith(['vault-settings'], 'readwrite')
    ...
    it('should handle save errors', async () => {
      ...
      const mockFiles = [new File(['content'], 'file.md', { webkitRelativePath: 'vault/file.md' })]
      const mockFileList = new FileList(mockFiles)
  ...
  describe('getVaultSettings', () => {
    it('should retrieve vault settings successfully', async () => {
      ...
      expect(mockDB.transaction).toHaveBeenCalledWith(['vault-settings'], 'readonly')
  ...
  describe('isValidObsidianVault', () => {
    it('should return true for valid Obsidian vault', async () => {
      const files = [
        { path: 'vault/file1.md', lastModified: 123, size: 100, type: 'text/markdown' },
        { path: 'vault/.obsidian/config.json', lastModified: 123, size: 50, type: 'application/json' },
        { path: 'vault/notes/note.md', lastModified: 123, size: 200, type: 'text/markdown' }
      ]
    ...
    it('should return false for invalid vault', async () => {
      const files = [
        { path: 'vault/file1.md', lastModified: 123, size: 100, type: 'text/markdown' },
        { path: 'vault/file2.txt', lastModified: 123, size: 50, type: 'text/plain' }
      ]
